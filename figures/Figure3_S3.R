...
library(ggplot2)
WholeGenes_Ridge = readRDS("../data/all_genes_ridge.rds")
Landmark_Ridge = readRDS("../data/Landmark_Ridge.rds")
Drug_Pathways_Ridge = readRDS("../data/Drug_Pathway_genes_ridge.rds")
TF_activity_Ridge = readRDS("../data/TF_activity_ridge.rds")
Pathway_activity_Ridge = readRDS("../data/Pathway_activity_ridge.rds")

WholeGenes_Lasso = readRDS("../data/all_genes_Lasso.rds")
Landmark_Lasso = readRDS("../data/Landmark_Lasso.rds")
Drug_Pathways_Lasso = readRDS("../data/Drug_Pathway_genes_Lasso.rds")
TF_activity_Lasso = readRDS("../data/TF_activity_Lasso.rds")
Pathway_activity_Lasso = readRDS("../data/Pathway_activity_Lasso.rds")

WholeGenes_ENet = readRDS("../data/all_genes_ENet.rds")
Landmark_ENet = readRDS("../data/Landmark_ENet.rds")
Drug_Pathways_ENet = readRDS("../data/Drug_Pathway_genes_ENet.rds")
TF_activity_ENet = readRDS("../data/TF_activity_ENet.rds")
Pathway_activity_ENet = readRDS("../data/Pathway_activity_ENet.rds")

WholeGenes_RF = readRDS("../data/all_genes_RF.rds")
Landmark_RF = readRDS("../data/Landmark_RF.rds")
Drug_Pathways_RF = readRDS("../data/Drug_Pathway_genes_RF.rds")
TF_activity_RF = readRDS("../data/TF_activity_RF.rds")
Pathway_activity_RF = readRDS("../data/Pathway_activity_RF.rds")

WholeGenes_MLP = readRDS("../data/all_genes_MLP.rds")
Landmark_MLP = readRDS("../data/Landmark_MLP.rds")
Drug_Pathways_MLP = readRDS("../data/Drug_Pathway_genes_MLP.rds")
TF_activity_MLP = readRDS("../data/TF_activity_MLP.rds")
Pathway_activity_MLP = readRDS("../data/Pathway_activity_MLP.rds")
